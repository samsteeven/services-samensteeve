...
export function GET() {
  ...
  const body = [
    ...
    "## Agent Discovery",
    "",
    `- [Auth.md](${BASE_URL}/auth.md): Agent registration manifest with identity types and registration methods`,
    ...
    `- [DNS-AID](${BASE_URL}/.well-known/dns-aid): DNS for AI Discovery records and setup guidance (RFC draft-mozleywilliams-dnsop-dnsaid)`,
    "",
    "## Contact",
    "",
