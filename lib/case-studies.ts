    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "A single MCP URL is enough: ChatGPT, Claude, Cursor or opencode can read my base (sourced answers) and enrich it (classified, quarantined notes). Everything runs in production with zero extra API cost, and a quality pipeline (dedup on write, weekly housekeeping) keeps the base clean and well-organized. And it doesn't stop at applications: the same base helps prepare an interview, find a technical decision, or feed my articles. Time saved every time. And above all, the AI knows how I develop: on a new project, it applies my conventions and best practices, instead of producing generic code."
        }
      ],
      repoUrl: "https://github.com/samsteeven/sam-second-brain",
      siteUrl: undefined
