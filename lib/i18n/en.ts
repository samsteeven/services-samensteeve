export const en = {
  ...
  metadata: {
    homeTitle: "Freelance Software Engineer & Solution Architect — Douala",
    homeDescription: "I design, secure, and automate software systems for companies that need things to work in production. Software engineering, cloud architecture, application pentest, AI automation.",
    blogTitle: "Field Notes — Blog",
    blogDescription: "Technical analysis and real-world experience reports on AI, cloud, security, and software engineering in production by Samen Steeve.",
    processTitle: "How it works",
    processDescription: "A transparent 4-phase methodology: discovery, architecture, iterative build, and deployment. No black box, concrete deliverables at every step.",
    contactTitle: "Start a project",
    contactDescription: "Describe your project in 6 simple steps. Response within 24 hours with a technical analysis and a concrete proposal.",
    realisationsTitle: "Case Studies",
    realisationsDescription: "Case studies of projects designed, built, and shipped to production: legaltech platform, hybrid cloud architecture, agro-industrial microservices.",
    servicesTitle: "Software engineering services",
    servicesDescription: "Software engineering, cloud architecture, application pentest, and AI automation for production systems.",
